-- Apply in Supabase SQL Editor after Phase 4.
-- https://supabase.com/dashboard/project/ujhjdqijrylcwihxpdpa/sql/new
-- Same SQL as supabase/migrations/20260908140000_quiz_questions.sql
--
-- Phase 4b: relax quizzes.slug so any course can have a final (keep one-final-per-course),
-- and store MCQ banks in quiz_questions. DPTC Module 1 + final stay in TypeScript.
-- Learners never select correct_index; the app scores via the service role.
