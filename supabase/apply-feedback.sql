...
-- Same SQL as supabase/migrations/20260919120000_feedback_tickets.sql
--
-- Public FAB tickets (named from session, or Anonymous) insert via the
-- service-role client. Staff (is_staff) can select and update for triage.
