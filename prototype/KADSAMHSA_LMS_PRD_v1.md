> **Stack in §8 is deprecated.** Use [KADSAMHSA_LMS_PRD_v2.md](KADSAMHSA_LMS_PRD_v2.md) for the active product contract and stack. This v1 document is retained as a historical record; product requirements in §§1–7 and §9 are unchanged.
